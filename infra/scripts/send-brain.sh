...
scp -i $PK_INFRA_PATH/pk-key.pem brain/ens_linucb03.pkl ubuntu@$PK_FLASK_PUBLIC_IP:~
scp -i $PK_INFRA_PATH/pk-key.pem brain/makurly_RS.py ubuntu@$PK_FLASK_PUBLIC_IP:~
